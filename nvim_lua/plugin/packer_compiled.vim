...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/dashboard-nvim"
  },
  ["friendly-snippets"] = {
    loaded = true,
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/git-blame.nvim"
  },
  ["gitsigns.nvim"] = {
    loaded = true,
  ...
  ["hop.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/hop.nvim"
  },
  ...
  ["nvcode-color-schemes.vim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvcode-color-schemes.vim"
  },
  ["nvim-autopairs"] = {
    loaded = true,
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvim-comment"
  },
  ["nvim-compe"] = {
    loaded = true,
  ...
  ["nvim-lightbulb"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvim-lightbulb"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
    loaded = true,
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag"
  },
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
